...
<head>
  ...
  <title>Guess The Number - Level 2</title>
...
<body style="background-color: black">
  <!-- Page Header -->
  <header class="picTwo" style="background-color: black"></header>
  ...
  <!-- Main Content -->
    ...
    <div class="container font" style="margin-bottom: 20%; margin-top: 20%">
        ...
        <form action="" method="post" >
            <p class="font"> Enter Guess: <input type="number" id="guessNum" name="guessNum" min="1" max="50"/></p>
