...
<head>
  ...
  <title>Guess The Number - Level 3</title>
...
<body style="background-color: black">
  <!-- Page Header -->
  <header class="picThree" style="background-color: black"></header>
  ...
  <!-- Main Content -->
    ...
    <div class="container font" style="margin-bottom: 20%; margin-top: 20%">
        ...
        <form action="" method="post" >
            <p class="font"> Enter Guess: <input type="number" id="guessNum" name="guessNum" min="1" max="100"/></p>
            <input class="font" type="submit" value="Guess" name="button">
        </form>
        <a href="index.php" style="align-items: flex-start" ><input name="reset" class="reset" type="submit" value="New Game"></a><br><br>
    </div>
